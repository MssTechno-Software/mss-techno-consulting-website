...
const MEETING_OPTIONS = [
  {
    ...
    duration: "30 Minutes",
    description:
      "Build a strong, ATS-friendly resume that presents your skills, projects, experience, and career profile clearly."
  },
  {
    id: "linkedin",
    ...
    duration: "30 Minutes",
    description:
      "Strengthen your LinkedIn profile with professional positioning, keyword optimization, and a recruiter-friendly presentation."
  },
  {
    id: "interview",
    ...
    duration: "45 Minutes",
    description:
      "Prepare for technical and HR interviews with focused guidance, mock interview practice, and confident communication."
  },
  {
    id: "job-assistance",
    ...
    duration: "60 Minutes",
    description:
      "Get practical guidance on job applications, opportunities, placement preparation, and the next steps in your career journey."
  }
];
...
const MeetingModal = ({ isOpen, onClose }) => {
  ...
  const fetchTimeSlots = async () => {
    ...
    try {
      ...
      setTimeslots([]);
      setSlotsError("We couldn't load the available consultation slots. Please try again.");
    } finally {
  ...
  const processingMessages = [
    ...
    "Preparing your Microsoft Teams consultation...",
    "Creating your calendar invitation...",
    "Confirming your consultation with MSS Techno...",
    "Preparing your MSS Techno career consultation confirmation...",
    "Finalizing your career consultation booking..."
  ];
  ...
  const handleContinue = () => {
    if (!selectedTimezone || !selectedTimezone.value) {
      setTimeZoneError("Please select your time zone so we can show the right consultation times.");
      return;
    }
  ...
  const validateStepTwo = () => {
    ...
    if (!attendeeName.trim()) {
      errors.attendeeName = "Please enter your name so our team knows who we're meeting with.";
    }

    if (!attendeeEmail.trim()) {
      errors.attendeeEmail = "Please enter a valid business email address.";
    } else if (!emailRegex.test(attendeeEmail.trim())) {
      errors.attendeeEmail = "Please enter a valid business email address.";
    }

    if (!selectedDate) {
      errors.selectedDate = "Please choose a date for your career consultation.";
    }

    if (!selectedTime) {
      errors.selectedTime = "Please choose an available career consultation time.";
    }
  ...
  const handleBookMeeting = async () => {
    ...
    if (!validateStepTwo()) {
      showToast("Please complete the required career consultation details correctly.");
      return;
    }
    ...
    try {
      ...
      const friendlyMsg = isNetworkError
        ? "We couldn't connect to the MSS Techno scheduling service. Please check your connection and try again."
        : "We couldn't schedule your MSS Techno career consultation right now. Please try again.";
    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[100000] flex items-center justify-center p-4 sm:p-6 md:p-8 overflow-y-auto selection:bg-[#4D8B4F]/10 selection:text-[#4D8B4F]">
          ...
          {/* Back to Career Service Detailsdrop */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
              ...
              {isContinuing ? (
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-500 font-medium tracking-wide">
                      Please hold on while we confirm your career consultation
                    </p>
                  </motion.div>
                ...
                >
                  <div className="text-center space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <h3 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900">
                        Your MSS Techno Career Consultation Is Confirmed
                      </h3>
                      <p className="text-xs text-slate-500 max-w-md mx-auto">
                        Your Microsoft Teams career consultation is confirmed and the meeting details have been prepared for you.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-slate-50/70 border border-slate-200/80 backdrop-blur-sm rounded-2xl p-6 space-y-4 shadow-sm">
                      <div className="flex justify-between items-center border-b border-slate-200/60 pb-3">
                        <span className="text-[11px] font-bold tracking-wider text-slate-400 uppercase">CONSULTATION</span>
                      ...
                      <div className="flex justify-between items-center border-b border-slate-200/60 pb-3">
                        <span className="text-[11px] font-bold tracking-wider text-slate-400 uppercase">YOUR TIME ZONE</span>
                    ...
                    <div className="bg-slate-50/70 backdrop-blur-sm border border-slate-200/80 border-l-[5px] border-l-[#4D8B4F] rounded-2xl p-6 shadow-sm flex flex-col justify-between">
                      <div>
                        ...
                        <ul className="space-y-3.5 text-xs text-slate-600">
                          <li className="flex items-start gap-2.5">
                            ...
                            <span>Your meeting invitation and Microsoft Teams link will be sent to your email.</span>
                          </li>
                          <li className="flex items-start gap-2.5">
                            <CheckCircle2 className="w-4 h-4 text-[#4D8B4F] shrink-0 mt-0.5" />
                            <span>The appointment will be added to your calendar.</span>
                          </li>
                          <li className="flex items-start gap-2.5">
                            <CheckCircle2 className="w-4 h-4 text-[#4D8B4F] shrink-0 mt-0.5" />
                            <span>Our team will review your goals and requirements before the call.</span>
                          </li>
                          <li className="flex items-start gap-2.5">
                            <CheckCircle2 className="w-4 h-4 text-[#4D8B4F] shrink-0 mt-0.5" />
                            <span>We'll use the session to understand your goals and recommend the right career next steps.</span>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="mt-6 pt-4 border-t border-slate-200/80 flex items-center gap-2 text-[11px] text-slate-500 font-medium">
                        ...
                        <span>Secure scheduling for your MSS Techno career consultation</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-2 flex flex-col sm:flex-row justify-center gap-3">
                    ...
                    >
                      Back to Career Service Details to Website
                    </button>
                    <button
                      onClick={handleCloseAndReset}
                ...
                >
                  <header className="text-left border-b border-slate-200 pb-5">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900 mt-1">Choose Your Career Consultation Time</h2>
                    <p className="text-xs text-slate-500 mt-1">Choose a convenient date and available time based on your selected time zone.</p>
                  </header>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-xs font-bold tracking-wider text-slate-700 uppercase flex items-center gap-1.5">
                        <User className="w-3.5 h-3.5 text-[#6B2D1A]" /> YOUR NAME
                      </label>
                      <input
                        type="text"
                        value={attendeeName}
                        ...
                        className={`w-full p-3.5 rounded-xl border ${fieldErrors.attendeeName ? "border-red-400 bg-red-50/20" : "border-slate-200 bg-white"
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full p-3.5 rounded-xl border ${fieldErrors.attendeeEmail ? "border-red-400 bg-red-50/20" : "border-slate-200 bg-white"
                          } text-slate-900 text-sm font-semibold outline-none focus:ring-2 focus:ring-[#4D8B4F]/20 focus:border-[#4D8B4F] transition-all shadow-sm`}
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full p-3.5 rounded-xl border ${fieldErrors.selectedDate ? "border-red-400 bg-red-50/20" : "border-slate-200 bg-white"
                            } text-slate-900 text-sm font-semibold outline-none focus:ring-2 focus:ring-[#4D8B4F]/20 focus:border-[#4D8B4F] transition-all shadow-sm`}
                        />
                      </div>
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-bold tracking-wider text-slate-700 uppercase flex items-center gap-1.5">
                        <Clock className="w-3.5 h-3.5 text-[#6B2D1A]" /> AVAILABLE TIME
                      </label>
                      ...
                      <div className="grid grid-cols-2 gap-2.5">
                        {isLoadingSlots ? (
                          <div className="col-span-2 flex items-center justify-center py-6 text-slate-500 text-xs font-semibold gap-2 border border-slate-200/80 rounded-xl bg-slate-50/50">
                            ...
                            <span>Finding available MSS Techno career consultation times...</span>
                          </div>
                        ) : slotsError ? (
                          ...
                          <p className="col-span-2 text-center text-sm text-slate-500 mt-4 pr-[70px]">
                            Choose a date to see available career consultation times.
                          </p>
                        ) : timeslots.length === 0 ? (
                          <p className="col-span-2 text-center text-sm text-slate-500 mt-4 pr-[90px]">
                            No career consultation slots are available on this date. Please choose another date.
                          </p>
                        ) : (
                          timeslots.map((slot, index) => {
                            ...
                            return (
                              <button
                                ...
                                className={`p-3 rounded-xl border text-xs font-bold transition-all duration-200 flex items-center justify-center gap-2 ${isLoadingSlots ? "opacity-50 cursor-not-allowed " : ""
                                  }${isSelected
                  ...
                  <div className="flex justify-between items-center pt-6 border-t border-slate-200">
                    ...
                    >
                      Back to Career Service Details
                    </button>
                    <button
                      onClick={handleBookMeeting}
                      disabled={isContinuing}
                      className={`px-7 py-3 rounded-xl text-white text-xs font-bold bg-[#6B2D1A] hover:bg-[#582415] active:scale-95 transition-all shadow-sm flex items-center gap-2 group ${isContinuing ? "opacity-60 cursor-not-allowed" : ""
                        }`}
                    >
                      {isContinuing ? (
                        <>
                ...
                >
                  <header className="text-left border-b border-slate-200 pb-4">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900 mt-1">Let's Build Your Next Career Step</h2>
                    <p className="text-xs text-slate-500 mt-1">Choose the career service that best matches what you need help with right now.</p>
                  </header>
                  ...
                  {/* YOUR TIME ZONE SELECTOR IMPLEMENTATION */}
                  <div className="space-y-2 pt-2">
                    <div className="flex justify-between items-center">
                      <label className="text-xs font-bold tracking-wider text-slate-700 uppercase flex items-center gap-1.5">
                        <Globe className="w-3.5 h-3.5 text-[#6B2D1A]" /> YOUR TIME ZONE
                      </label>
                      {isOtherSearchMode && (
                        <button
                          type="button"
                    ...
                    {!isOtherSearchMode ? (
                      <select
                        ...
                        className={`w-full p-3.5 rounded-xl border ${timeZoneError ? "border-red-400 bg-red-50/20" : "border-slate-200 bg-white"
                      ...
                      >
                        ...
                        <option value="OTHER">Other — Search global time zones...</option>
                      </select>
                    ) : (
                      <Select
                        ...
                        placeholder="Search city, country, or time zone (e.g. Hyderabad, Dubai, EST)..."
                  ...
                  <div className="flex justify-end items-center pt-4 border-t border-slate-200">
                    ...
                    >
                      Continue to Career Consultation
                      <ArrowRight className="w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5" />
                    </button>
                  </div>
                </motion.div>
